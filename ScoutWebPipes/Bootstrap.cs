...
namespace SteamWebPipes
{
    ...
    {
        public class SteamWebPipesConfiguration
        {
        ...
        {
            public SteamWebPipesConfiguration SteamWebPipes { get; set; }
        }

        private static int LastBroadcastConnectedUsers;
        private static readonly List<IWebSocketConnection> ConnectedClients = new();
        public static SteamWebPipesConfiguration Config { get; private set; }
        ...
        private static void Main()
        {
            ...
            var allConfig = JsonSerializer.Deserialize<Configuration>(File.ReadAllText(Path.Combine(AppContext.BaseDirectory, "config.json")));
            Config = allConfig.SteamWebPipes;
